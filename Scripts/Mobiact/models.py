...
class HN(nn.Module):
    ...
    def forward(self, idx):
        ...
        weights = OrderedDict({
            "conv1.weight": self.conv1_weights(features).view(self.n_kernels, 1, 3, 3),
            ...
            "t_conv1.weight": self.t_conv1_weights(features).view(self.latent_rep, self.n_kernels, 1, 1),
            "t_conv1.bias": self.t_conv1_bias(features).view(-1),
            "t_conv2.weight": self.t_conv2_weights(features).view(self.n_kernels, self.in_channels, 1, 1),
